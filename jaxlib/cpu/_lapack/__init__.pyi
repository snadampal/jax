...
def cgesdd_work_size_ffi(m: int, n: int, mode: svd.ComputationMode) -> int: ...
...
def lapack_cgehrd_workspace_ffi(lda: int, n: int, ilo: int, ihi: int) -> int: ...
def lapack_cgeqrf_workspace_ffi(m: int, n: int) -> int: ...
def lapack_chetrd_workspace_ffi(lda: int, n: int) -> int: ...
def lapack_cungqr_workspace_ffi(m: int, n: int, k: int) -> int: ...
def lapack_dgehrd_workspace_ffi(lda: int, n: int, ilo: int, ihi: int) -> int: ...
def lapack_dgeqrf_workspace_ffi(m: int, n: int) -> int: ...
def lapack_dorgqr_workspace_ffi(m: int, n: int, k: int) -> int: ...
def lapack_dsytrd_workspace_ffi(lda: int, n: int) -> int: ...
def lapack_sgehrd_workspace_ffi(lda: int, n: int, ilo: int, ihi: int) -> int: ...
def lapack_sgeqrf_workspace_ffi(m: int, n: int) -> int: ...
def lapack_sorgqr_workspace_ffi(m: int, n: int, k: int) -> int: ...
def lapack_ssytrd_workspace_ffi(lda: int, n: int) -> int: ...
def lapack_zgehrd_workspace_ffi(lda: int, n: int, ilo: int, ihi: int) -> int: ...
def lapack_zgeqrf_workspace_ffi(m: int, n: int) -> int: ...
def lapack_zhetrd_workspace_ffi(lda: int, n: int) -> int: ...
